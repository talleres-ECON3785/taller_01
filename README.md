...
| 06 | `06_analisis_experimento.R`                        | Contingencia`sign_up` × `easier_signup`, ITT de `easier_signup` sobre `Revenue` y chequeos de especificación.                                                                       | `tabla_contingencia_signup_easier_signup.csv`, `tabla_itt_experimento.docx`                                                                                                                                                                                                                              | —                                                                                                                                                                                                                                                                                                                                |
...
| 10 | `10_regresion_correlacional_observacional.R`       | Asociación (correlacional, no causal) entre`sign_up` y `log(Revenue)` en la base observacional.                                                                                          | `tabla_elasticidad_timespent_observacional.csv`                                                                                                                                                                                                                                                            | —                                                                                                                                                                                                                                                                                                                                |
