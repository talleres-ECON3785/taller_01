...
grafica_tiempo_revenue <- ggplot(
  ...
  scale_y_log10() +
  labs(
    title = "Relacion entre tiempo en el sitio e ingresos (base del experimento)",
    subtitle = str_wrap(sprintf(
      paste(
        "Datos del experimento A/B: solo easier_signup esta aleatorizado,",
        "time_spent NO. Relacion CORRELACIONAL, no causal. Cada punto es el",
        "promedio de ~%s sesiones (%s grupos de tamano similar segun",
        "tiempo en el sitio)."
      ),
...
ggsave("03_Resultados/Figuras/experimento_relacion_tiempo_revenue_quiebre.png",
